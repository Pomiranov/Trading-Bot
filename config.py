...
# Явный путь: при запуске из планировщика cwd = System32, и load_dotenv()
# без аргумента не нашёл бы .env проекта
...
class AppConfig:
    ...
    rules_file: Path = BASE_DIR / "knowledge" / "rules" / "rules.yaml"
