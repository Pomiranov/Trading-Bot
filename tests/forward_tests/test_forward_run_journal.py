...
Предмет. 01.08 прогон уехал с слота 00:15 на 11:38 (машина спала, долг №45), и
...
Почему нужен льготный интервал. Замерено 01.08: при догоне после сна планировщик
...
class TestRunDidNotHappen(JournalCase):
    ...
    def test_1_no_start_record_for_the_slot(self):
        ...
        Ровно ночь на 01.08: слот 00:15 прошёл, прогона не было, машина спала.
